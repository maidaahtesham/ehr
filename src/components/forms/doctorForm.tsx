  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      <h1 className="text-xl font-semibold">
        {type === "create" ? "Create a new doctor" : "Update doctor information"}
      </h1>
      ...
      {/* Personal Info */}
      <span className="text-xs text-gray-400 font-medium">Doctor's Details</span>
      <div className="flex justify-between flex-wrap gap-4">
        <InputField
          label="First Name"
          name="firstName"
        ...
        <InputField
          label="Schedule (e.g., Mon AM, Wed PM)"
          name="schedule"
      ...
      <button className="bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600 transition">
        {type === "create" ? "Create Doctor" : "Update Doctor"}
      </button>
    </form>
  );
};
